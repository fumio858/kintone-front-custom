        ...
        actionElements.forEach((el, index) => {
          ...
          if (actionLabel) {
            ...
            if (actionTitle === '現在の作業者を変更') {
              ...
              style = "margin: .5rem; border: 1px solid #e3e7e8; background-color: #ffffff; box-shadow: 1px 1px 1px #fff inset; color: #3498db; border-radius: 46px;"; // Change background to white and add border-radius
